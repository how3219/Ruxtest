...
const IdfindScreen = props => {
    ...
    const findId = async () => {
        try {
            ...
            form.append('method', 'proc_search_id');
            ...
            console.log('IDFIND', e)
        }
    }
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }}>
            <DetailHead title="아이디 찾기" />
                ...
                <View>
                    ...
                    <View style={{ flexDirection: 'row', marginBottom: 30 }}>
                        <TouchableOpacity style={{ paddingHorizontal: 5, flexDirection: 'row' }}>
                            ...
                            <Text style={{ lineHeight: 24, fontSize: 16, fontWeight: '600' }}>회원명</Text>
                        </TouchableOpacity>
